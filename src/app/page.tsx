      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8 lg:p-12">
        <div className="w-full max-w-7xl mx-auto">
          <header className="text-center mb-12 md:mb-24">
            <h1 className="text-5xl md:text-7xl font-extrabold font-headline tracking-tighter bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent pb-2">
              ChronoFolio
            </h1>
